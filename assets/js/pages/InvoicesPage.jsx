...
const InvoicesPage = (props) => {
    ...
    // Récupération les invoices aupres de l'API
               ...
               {!loading && <tbody>
                    {paginatedInvoices.map(invoice => 
                        <tr key={invoice.id}>
                            ...
                            <td>
                                <Link to={"/invoices/" + invoice.id} className="btn btn-m btn-primary mr-1">Editer</Link>
                                <button className="btn btn-m btn-danger" onClick={() => handleDelete(invoice.id)}>Supprimer</button>
                            </td>
                        </tr>
                    )}
                </tbody>}
